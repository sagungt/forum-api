...
DomainErrorTranslator._directories = {
  ...
  'DELETE_COMMENT.INVALID_OWNERSHIP': new AuthorizationError('anda tidak memiliki hak akses'),
  ...
  'DELETE_REPLY.INVALID_OWNERSHIP': new AuthorizationError('anda tidak memiliki hak akses'),
};
